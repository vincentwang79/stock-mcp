...
行业 JSON；在三年同源日线回填成功后，管理员显式运行 `stock-mcp build-v3-facts --root E:\\StockMcp --start 2023-08-08 --end 2026-08-07`，只以本机 SQLite 与发布内行业 JSON 构建不可变 v3 事实。具体升级、诊断、回滚和卸载流程见
[Windows Server 部署手册](deploy/windows/README-WINDOWS.md)。
